<?php /* Smarty version 2.6.19, created on 2015-03-18 08:58:07
         compiled from gebo/correction/corrector-profiles-list.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/correction/corrector-profiles-list.phtml', 50, false),array('function', 'math', 'gebo/correction/corrector-profiles-list.phtml', 104, false),array('modifier', 'stripslashes', 'gebo/correction/corrector-profiles-list.phtml', 98, false),array('modifier', 'wordwrap', 'gebo/correction/corrector-profiles-list.phtml', 98, false),array('modifier', 'upper', 'gebo/correction/corrector-profiles-list.phtml', 98, false),array('modifier', 'date_format', 'gebo/correction/corrector-profiles-list.phtml', 99, false),)), $this); ?>
<?php echo '
...
?>
        <tr>
            ...
            <td>
                <a data-target="#artprofile" role="button" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
...
<?php endif; ?></a></td>
            <td><a data-target="#artprofile" role="button" class="num-large" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['profiles_item']['artsincrt'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
  </a>
                <span class="label label-success"> of <a data-target="#artprofile" role="button" style="color: #ffffff" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['profiles_item']['artCount'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
            ...
            <a data-target="#artprofile" role="button" class="num-large" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
&crtstatus=affect"><?php echo $this->_tpl_vars['profiles_item']['affectedart']; ?>
            ...
            <a data-target="#artprofile" role="button" class="num-large" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
&crtstatus=reaffect"><?php echo $this->_tpl_vars['notaffectedart']; ?>
</a><?php else: ?> 0 <?php endif; ?></td>
            <td><?php if ($this->_tpl_vars['profiles_item']['bidencours'] != 0): ?>
            <a data-target="#artprofile" role="button" class="num-large" href="/correction/corrector-article-profiles?submenuId=ML2-SL18&aoId=<?php echo $this->_tpl_vars['profiles_item']['id']; ?>
&crtstatus=encours"><?php echo $this->_tpl_vars['profiles_item']['bidencours']; ?>
</a><?php else: ?> 0 <?php endif; ?></td>
