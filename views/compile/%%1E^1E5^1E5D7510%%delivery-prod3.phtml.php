<?php /* Smarty version 2.6.19, created on 2016-03-03 08:24:41
         compiled from gebo/bnpquotedelivery/delivery-prod3.phtml */ ?>
<?php echo '
...
<script>
	$(document).ready(function(){
		...
		$("#fbcomment").counter({
		 ...
		 var target_page = "/bnp-quotedelivery/getcontribmailcontent";
		...
		var ctarget_page = "/bnp-quotedelivery/getproofreadmailcontent";
	 ...
	 <div class="span12">
		<h3 class="heading">
			...
			<span class="pull-right">
					...
					<map name="Map" id="Map">
						<area shape="circle" coords="18,18,17" href="/bnp-quotedelivery/delivery-prod1?mission_id=<?php echo $_GET['mission_id']; ?>
"/>
						<area shape="circle" coords="60,18,17" href="/bnp-quotedelivery/delivery-prod2?mission_id=<?php echo $_GET['mission_id']; ?>
"/>
					</map>
			</span> 
		</h3>
	...
	<div class="row-fluid">
		<form class="form-horizontal"  action="/bnp-quotedelivery/save-prod3" method="POST" id="delivery-prod-form3" enctype="multipart/form-data">
			<div class="span6">				
				 <div class="border">
...
" name="mailsubject" id="mailsubject" placeholder="Edit Place: Writing premium mission">
		 ...
		 <div class="row-fluid">
			<div class="span8 topset2">
				<a class="btn btn-default" href="/bnp-quotedelivery/delivery-prod2?mission_id=<?php echo $_GET['mission_id']; ?>
