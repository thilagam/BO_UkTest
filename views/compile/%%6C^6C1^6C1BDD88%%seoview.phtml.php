<?php /* Smarty version 2.6.19, created on 2013-09-26 15:24:12
         compiled from skeleton/seoview.phtml */ ?>
<!DOCTYPE html>
<html lang="fr">
    <head>
...
"></script>
    ...
    <body style="background: none;">
		...
		<div id="seoviewresultspage" class="main_content">		
				...
				<div class="row-fluid"><?php echo $this->_tpl_vars['table']; ?>
</div>
			</div>
		</div>
...
'; ?>
<?php if (! $this->_tpl_vars['sheet_count']): ?><?php echo '
            if($(\'#smpl_tbl\').length) {
                $(\'#smpl_tbl\').dataTable({
...
'; ?>
<?php else: ?><?php $_from = $this->_tpl_vars['sheet_count']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
'; ?>
<?php endforeach; endif; unset($_from); ?><?php endif; ?><?php echo '
        });
    </script>
'; ?>
