<?php /* Smarty version 2.6.19, created on 2016-02-01 16:41:13
         compiled from gebo/index/dashboard.phtml */ ?>
	...
	<div class="span12 tac">
		<ul class="ov_boxes">
			<li><a href="/user/clients?submenuId=ML10-SL2">
				...
				<div class="ov_text">
					<strong><?php echo $this->_tpl_vars['totalActiveClients']; ?>
</strong>
					Clients
				</div></a>
			</li>
			<li><a href="/user/contributors?submenuId=ML10-SL1">
				...
				<div class="ov_text">
					<strong><?php echo $this->_tpl_vars['totalActiveWriters']; ?>
</strong>
					Writers
				</div></a>
			</li>
			<li><a href="/ongoing/list?submenuId=ML2-SL4">
				...
				<div class="ov_text">
					<strong><?php echo $this->_tpl_vars['TotalDeliveries']; ?>
</strong>
					Deliveries
				</div></a>
			</li>
			<li><a href="/ongoing/list?submenuId=ML2-SL4">
				...
				<div class="ov_text">
					<strong><?php echo $this->_tpl_vars['TotalArticles']; ?>
</strong>
					Articles
				</div></a>
			</li>
...
<div class="row-fluid">
	<div class="span12">
		<ul class="dshb_icoNav tac">
			...
			<li><a href="/ongoing/list?submenuId=ML2-SL4" style="background-image: url(/BO/theme/gebo/img/gCons/add-item.png)">Ongoing Deliveries</a></li>
			<li><a href="/processao/profiles-list?submenuId=ML2-SL2" style="background-image: url(/BO/theme/gebo/img/gCons/ID.png)">Selection of profiles</a></li>
		    <li><a href="/user/users-list?submenuId=ML3-SL6&tab=permissionstab" style="background-image: url(/BO/theme/gebo/img/gCons/configuration.png)">Permissions</a></li>
...
<div class="row-fluid">
    <div class="span6" id="cstmm">
        <div class="heading clearfix">
            <h3 class="pull-left">New clients on the platform</h3>
    ...
    <div class="span6" id="cstmm">
        <div class="heading clearfix">
            <h3 class="pull-left">New contributors on the platform</h3>
            <span class="span4 pull-right">
...
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['ticks_dusers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
        ...
        cfl_d : function() {
            ...
            '; ?>
<?php echo $this->_tpl_vars['cdates']; ?>
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['cticks_dusers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
        ...
        fl_w : function() {
            ...
            '; ?>
<?php echo $this->_tpl_vars['week_dates']; ?>
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['ticks_wusers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
                    ...
                    timeformat: "%b %d",
                    ticks: '; ?>
<?php echo $this->_tpl_vars['ticks_week_dates']; ?>
<?php echo ',
                    tickSize: [7, "day"],
                    minTickSize: [7, "day"],
                    autoscaleMargin: 0.10
        ...
        cfl_w : function() {
            ...
            '; ?>
<?php echo $this->_tpl_vars['cweek_dates']; ?>
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['cticks_wusers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
...
<?php echo ',
        ...
        fl_m : function() {
            ...
            '; ?>
<?php echo $this->_tpl_vars['mnth_dates']; ?>
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['ticks_musers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
        ...
        cfl_m : function() {
            ...
            '; ?>
<?php echo $this->_tpl_vars['cmnth_dates']; ?>
<?php echo '
            ...
            var options = {
                ...
                yaxes: [
                    {min: 0},
                    {max: '; ?>
<?php echo $this->_tpl_vars['cticks_musers_max']; ?>
<?php echo '},
                    {position: "left"}
                ],
                xaxis: {
