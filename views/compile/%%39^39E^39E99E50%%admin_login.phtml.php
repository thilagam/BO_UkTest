<?php /* Smarty version 2.6.19, created on 2013-06-17 15:03:43
         compiled from skeleton/admin_login.phtml */ ?>
<!DOCTYPE html>
<html lang="en" class="login_page">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>edit-place Panel - Login Page</title>
    
        <!-- Bootstrap framework -->
            <link rel="stylesheet" href="/BO/gebo/bootstrap/css/bootstrap.min.css" />
            <link rel="stylesheet" href="/BO/gebo/bootstrap/css/bootstrap-responsive.min.css" />
        <!-- theme color-->
            <link rel="stylesheet" href="/BO/gebo/css/blue.css" />
        <!-- tooltip -->    
			<link rel="stylesheet" href="/BO/gebo/lib/qtip2/jquery.qtip.min.css" />
        <!-- main styles -->
            <link rel="stylesheet" href="/BO/gebo/css/style.css" />
    
        <!-- Favicon -->
            <link rel="shortcut icon" href="/BO/gebo/favicon.ico" />
    ...
    <body>
		...
		<div class="login_box">
			...
			<form action="dashboard.html" method="post" id="reg_form" style="display:none">
				<div class="top_b">Sign up to edit-place</div>
...
<?php echo '		
        <script src="/BO/gebo/js/jquery.min.js"></script>
        <script src="/BO/gebo/js/jquery-migrate.min.js"></script>
        <script src="/BO/gebo/js/jquery.actual.min.js"></script>
        <script src="/BO/gebo/lib/validation/jquery.validate.min.js"></script>
		<script src="/BO/gebo/bootstrap/js/bootstrap.min.js"></script>
        <script>
