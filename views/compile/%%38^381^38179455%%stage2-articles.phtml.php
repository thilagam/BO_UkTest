<?php /* Smarty version 2.6.19, created on 2013-06-28 07:30:56
         compiled from gebo/processao/stage2-articles.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/processao/stage2-articles.phtml', 75, false),array('modifier', 'stripslashes', 'gebo/processao/stage2-articles.phtml', 144, false),array('modifier', 'wordwrap', 'gebo/processao/stage2-articles.phtml', 144, false),)), $this); ?>
<?php echo '
...
?>
            <tr>
                <td><?php echo ($this->_foreach['2arts_loop']['iteration']-1)+1; ?>
</td>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['s2arts_item']['deliveryTitle'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('wordwrap', true, $_tmp, 20, "\n", true) : smarty_modifier_wordwrap($_tmp, 20, "\n", true)); ?>
</td>
