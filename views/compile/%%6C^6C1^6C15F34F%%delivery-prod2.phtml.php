<?php /* Smarty version 2.6.19, created on 2015-08-05 15:39:48
         compiled from gebo/quotedelivery/delivery-prod2.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'gebo/quotedelivery/delivery-prod2.phtml', 25, false),)), $this); ?>
<?php echo '
...
<?php echo '\';
		...
		$(\'input[name="repeat"]\').click(function () {
			...
			{
				var eve_url=\'/quotedelivery/repeat-delivery\';
				$("#repeat_delivery").modal({remote:eve_url});				
			}
			else
			{	
				var target_page=\'/quoteDelivery/repeat-delivery?unset=yes\';
		...
		$( "#shareCalendar" ).click(function( event ) {
			...
			var target_page=\'/quotedelivery/check-article-writers-correctors\';
...
function updateCalendar()
{
	...
	var target_page="/quotedelivery/ajax-update-calendar?publish_now="+now+"&publish_time="+publish_time;
	//alert(target_page);
...
<?php echo '\',
			...
			//eventLimit: true,
			events: \'/quotedelivery/calendar-article-events/\',
		 ...
		 <div class="span12">
			<h3 class="heading">
				...
				<span class="pull-right">
						...
						<map name="Map" id="Map">
							<area href="/quotedelivery/delivery-prod1?mission_id=<?php echo $_GET['mission_id']; ?>
...
" type="text" name="publish_time" id="publish_time" placeholder="publish time" <?php if ($this->_tpl_vars['prod_step2']['publish_now'] == 'yes'): ?> disabled <?php endif; ?> /><span class="add-on"><i class="splashy-calendar_day_up"></i></span>
 ...
 <a href="/quotedelivery/repeat-delivery" data-target="#repeat_delivery" role="button" data-toggle="modal">Edit</a>
				<?php endif; ?>
				</span>
	...
	<div class="row-fluid">
		<div class="control-group topset2">
			<div class="pull-center">
				<a class="btn btn-default" href="/quotedelivery/delivery-prod1?mission_id=<?php echo $_GET['mission_id']; ?>
"><i class="icon-chevron-left"></i> Retour</a>
				<a class="btn btn-primary" id="shareCalendar" href="/quotedelivery/delivery-prod3?mission_id=<?php echo $_GET['mission_id']; ?>
">Share</a>
			</div>
		</div>
	</div>
