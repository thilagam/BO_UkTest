<?php /* Smarty version 2.6.19, created on 2016-04-21 09:54:17
         compiled from gebo/followup/staff-followup.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'zero_cut_t', 'gebo/followup/staff-followup.phtml', 95, false),array('modifier', 'count', 'gebo/followup/staff-followup.phtml', 158, false),array('modifier', 'time_ago', 'gebo/followup/staff-followup.phtml', 166, false),array('modifier', 'stripslashes', 'gebo/followup/staff-followup.phtml', 169, false),array('modifier', 'strip_tags', 'gebo/followup/staff-followup.phtml', 169, false),array('modifier', 'nl2br', 'gebo/followup/staff-followup.phtml', 169, false),array('modifier', 'date_format', 'gebo/followup/staff-followup.phtml', 286, false),)), $this); ?>
<?php echo '
...
"<?php echo ';
	...
	$("#validate").click(function(){
		$(this).text(\'Validated\');
		$.post(\'/followup/validate-mission/\',{"cmid":cmid,\'to_date\':to_date,\'title\':title,\'type\':\'staff\',\'mission_id\':mission_id,\'contract_id\':contract_id,\'quote_id\':quote_id,\'assigned_to\':assigned_to},function(data){location.reload();}); 
	})
...
?>
					<div class="deliveryhover tasks">
						<h4><a href="/followup/stafftask?tid=<?php echo $this->_tpl_vars['task']['task_id']; ?>
&staff_action=view" data-toggle="modal" role="button" data-target="#view_task"><?php echo $this->_tpl_vars['task']['task_title']; ?>
						...
						<a href="/followup/stafftask?tid=<?php echo $this->_tpl_vars['task']['task_id']; ?>
&staff_action=view" data-toggle="modal" role="button" data-target="#view_task" class="btn btn-block btn-default">View Taskboard</a>
					</div>
					<?php endforeach; endif; unset($_from); ?>
					<?php endif; ?>
					<hr>
					<a class="btn btn-warning  btn-block" href="/followup/stafftask?cmid=<?php echo $this->_tpl_vars['viewarray']['cmid']; ?>
