<?php /* Smarty version 2.6.19, created on 2015-09-24 09:57:47
         compiled from gebo/template/logo_crop.phtml */ ?>
<?php echo '
...
'; ?>
	...
	<!-- Overlay brief client  -->
		...
		<form action="" method="post" id="crop_form">
            <?php if ($_GET['userId'] == ''): ?>
                <input type="hidden" id="userId" name="userId" value="<?php echo $this->_tpl_vars['loginuserId']; ?>
" />
            <?php else: ?>
