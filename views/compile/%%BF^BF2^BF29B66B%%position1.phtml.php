<?php /* Smarty version 2.6.19, created on 2015-03-24 12:01:15
         compiled from gebo/seo/position1.phtml */ ?>
<form class="form_validation_reg" method="POST" action="/seotool/posssh2_upload235" name="importcsv" id="seo" ENCTYPE="multipart/form-data">
        <div class="span10">
            ...
            <h3 class="heading">Calculation tool google ranking</h3>
            ...
            <div class="control-group formSep">
                <div class="row-fluid">
                    <div class="span12 form-inline">
                        ...
                        <label class="uni-radio"><input type="radio" name="word_type" class="uni_style"  value="1" <?php if ($this->_tpl_vars['word_type'] != '2'): ?> checked <?php endif; ?>>CSV / XLS</label>
                            <label class="uni-radio"><input type="radio" name="word_type" class="uni_style"  value="2" <?php if ($this->_tpl_vars['word_type'] == '2'): ?> checked <?php endif; ?>>Text</label>
                    </div>
                </div>
            </div>
            ...
            <div class="control-group formSep" id="urlRow" <?php if ($this->_tpl_vars['word_type'] != '2'): ?> style="display:none" <?php endif; ?> >
                <div class="row-fluid">
            ...
            <div class="control-group formSep" id="kwRow" <?php if ($this->_tpl_vars['word_type'] != '2'): ?> style="display:none" <?php endif; ?> >
                <div class="row-fluid">
                    <div class="control-group">
                        <label class="span3 control-label">Keywords<span class="f_req">*</span></label>
                        <div class="span8 controls">
                            <textarea name="kw" id="txtarea_sp" cols="1" rows="4" class="span10"  placeholder="Thank you pre enter your items this way: Input : url;kw url1;kw1 url2;kw2...etc not end with a ;"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="control-group formSep">
                <div class="row-fluid">
                    <div class="span12">
                        <label class="span3">Type</label>
                        <div class="span8 form-inline no-margin-first">
                            <label class="uni-radio"><input type="radio" name="type" class="uni_style" value="1" checked>Google position on a given url &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <a href="javascript:void(0);" class="pop_over" data-content="Thank you for your pre enter items this way:
Input :
url;kw
url1;kw1
url2;kw2...etc not end with a ;" data-original-title="Position Google sur une url donn&eacute;e" data-placement="right"><span class="splashy-information"></span></a>
                            </label>
                            <label class="uni-radio"><input type="radio" name="type" class="uni_style" value="2" >Best position on a Google domain
                                <a href="javascript:void(0);" class="pop_over" data-content="En dessous de url;kw
Input :
Merci de pr&#233;senter vos &#233;l&#233;ments de cette fa&#231;on:
url;kw
url1;kw1
url2;kw2...etc not end with a ; " data-original-title="Meilleure position Google sur un nom de domaine" data-placement="right"><span class="splashy-information"></span></a>
                            </label>
                            <label class="uni-radio"><input type="radio" name="type" class="uni_style" value="3" >Google position on a given url VS better position on the Google domain
                                <a href="javascript:void(0);" class="pop_over" data-content="En dessous de url;kw
Input :
Merci de pr&#233;senter vos &#233;l&#233;ments de cette fa&#231;on:
url;kw
url1;kw1
url2;kw2...etc not end with a ;" data-original-title="Position Google sur une url donn&eacute;e VS meilleure position Google sur le nom de domaine" data-placement="left"><span class="splashy-information"></span></a></label>
                            <label class="uni-radio"><input type="radio" name="type" class="uni_style" value="4" >Google position on a given url and comparison with the url of the better competitor
