<?php /* Smarty version 2.6.19, created on 2016-03-01 11:47:26
         compiled from gebo/quotedelivery/delivery-prod1.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'gebo/quotedelivery/delivery-prod1.phtml', 300, false),array('modifier', 'zero_cut', 'gebo/quotedelivery/delivery-prod1.phtml', 472, false),)), $this); ?>
<?php echo '
...
<?php echo '\';
	...
	var target_page=\'/quotedelivery/get-available-stencils-translate?language=\'+language+\'&token_id=\'+token_id;
	...
	$(document).ready(function(){
		...
		$(\'#delivery_name\').editable({
            url: \'/quotedelivery/update-deliveryname\',
            type: \'text\',
            name: \'delivery_name\',
            title: \'\',
...
">
 ...
 <?php echo $this->_tpl_vars['quoteMission']['product_type_other']; ?>
	...
	<div class="row-fluid">
		<div class="span9">
		<form class="form-horizontal"  action="/quotedelivery/save-prod1?mission_id=<?php echo $_GET['mission_id']; ?>
...
?>
                                    <?php if ($this->_tpl_vars['prod_step1']['city'] == $this->_tpl_vars['Id']): ?>
                                        <option value=<?php echo $this->_tpl_vars['Id']; ?>
  selected><?php echo $this->_tpl_vars['city']; ?>
</option>
                                    <?php else: ?>
                                        <option value=<?php echo $this->_tpl_vars['Id']; ?>
><?php echo $this->_tpl_vars['city']; ?>
                                    ...
                                    <?php endif; ?>
                                <?php endforeach; endif; unset($_from); ?><!--selected="selected"-->
                            </select>
                        </div>
                        <div class="span6 pull-center">
                            ...
                            <button type="button" class="btn btn-warning"  id="seeall" onclick="getbnpsampletexts()" name="seeall" value=""><?php if (! $this->_tpl_vars['sampletexts']): ?>See all<?php else: ?>Change Selection<?php endif; ?></button>
                            <div id="atokens" style="margin-top:10px">
				...
				<div class="row-fluid">
					...
					<div class="row-fluid">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" onkeyup="fncalculateRemainingArticles();" name="files_pack" id="files_pack" class="span4 validate[required]" value="<?php echo $this->_tpl_vars['prod_step1']['files_pack']; ?>
" />
							</div>
						</div>
					</div>
...
<?php echo '\';
	...
	$.post(\'/quotedelivery/sample-texts\',{"token_id":$("#mand_tokens").val(),"sample_id":$("#sampletext").val(),"language":checkLang},function(data)
	{
