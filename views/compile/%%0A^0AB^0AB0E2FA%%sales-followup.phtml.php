<?php /* Smarty version 2.6.19, created on 2015-08-19 11:56:50
         compiled from gebo/followup/sales-followup.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'zero_cut_t', 'gebo/followup/sales-followup.phtml', 95, false),array('modifier', 'count', 'gebo/followup/sales-followup.phtml', 156, false),array('modifier', 'time_ago', 'gebo/followup/sales-followup.phtml', 164, false),array('modifier', 'stripslashes', 'gebo/followup/sales-followup.phtml', 167, false),array('modifier', 'htmlentities', 'gebo/followup/sales-followup.phtml', 167, false),array('modifier', 'nl2br', 'gebo/followup/sales-followup.phtml', 167, false),array('modifier', 'date_format', 'gebo/followup/sales-followup.phtml', 284, false),)), $this); ?>
<?php echo '
...
'><?php echo $this->_tpl_vars['viewarray']['contract_name']; ?>
				...
				<?php endif; ?>
					...
					<p style="margin-top:10px"><a href="/quote/quote-followup?quote_id=<?php echo $this->_tpl_vars['quote_details']['identifier']; ?>
...
" class="image rd_30"></a>
					<a class="hint--right" data-hint="<?php echo $this->_tpl_vars['viewarray']['staff_name']; ?>
">
						<img src="<?php echo $this->_tpl_vars['fo_path']; ?>
/profiles/bo/<?php echo $this->_tpl_vars['viewarray']['assigned']; ?>
/logo.jpg" class="image rd_30" alt="<?php echo $this->_tpl_vars['viewarray']['staff_name']; ?>
">
					</a>
			</div>	
		</div>
...
<br>
								...
								<div><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['log']['comments'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlentities', true, $_tmp) : smarty_modifier_htmlentities($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</div>
							</div>
						</div>
...
<br>
							<?php endif; ?>
							<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['commentst']['comment'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlentities', true, $_tmp) : smarty_modifier_htmlentities($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
			...
			<div class="row-fluid">
				...
				<div class="pull-right" style="margin-bottom:5px">
					<a href="/quote/download-document?type=quote&index=-1&quote_id=<?php echo $this->_tpl_vars['quote_details']['identifier']; ?>
...
?>
					<div class="deliveryhover tasks">
						<h4><a href="/followup/salestask?tid=<?php echo $this->_tpl_vars['task']['task_id']; ?>
&staff_action=view" data-toggle="modal" role="button" data-target="#view_task"><?php echo $this->_tpl_vars['task']['task_title']; ?>
</a></h4>
						...
						<a href="/followup/salestask?tid=<?php echo $this->_tpl_vars['task']['task_id']; ?>
&staff_action=view" data-toggle="modal" role="button" data-target="#view_task" class="btn btn-block btn-default">View Taskboard</a>
					</div>
					<?php endforeach; endif; unset($_from); ?>
					<?php endif; ?>
					<hr>
					<a class="btn btn-warning  btn-block" href="/followup/salestask?cmid=<?php echo $this->_tpl_vars['viewarray']['cmid']; ?>
" data-toggle="modal" role="button" data-target="#new_task" id="newtask">
							Create new task</a>
			</div>
