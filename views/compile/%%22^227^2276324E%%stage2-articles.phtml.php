<?php /* Smarty version 2.6.19, created on 2013-06-28 14:12:50
         compiled from gebo/proofread/stage2-articles.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/proofread/stage2-articles.phtml', 75, false),array('modifier', 'stripslashes', 'gebo/proofread/stage2-articles.phtml', 144, false),array('modifier', 'wordwrap', 'gebo/proofread/stage2-articles.phtml', 144, false),)), $this); ?>
<?php echo '
<script type="text/javascript" >

    $(document).ready(function() {
        $(\'#s2artsgrid\').dataTable({
...
<div class="row-fluid">
  <div class="span12">
    <h3 class="heading">Stage 2 Articles<a data-toggle="modal"  href="#searchpopup" ></a></h3>

        <table id="s2artsgrid" class="table table-bordered table-striped table_vam">
            <thead>
            <tr>
                <th>Sl.no</th>
                <th>Titre AO</th>
            ...
            <tbody>
            <?php $_from = $this->_tpl_vars['paginator']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['s2arts_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['s2arts_loop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['s2arts_key'] => $this->_tpl_vars['s2arts_item']):
        $this->_foreach['s2arts_loop']['iteration']++;
?>
            <tr>
                <td><?php echo ($this->_foreach['s2arts_loop']['iteration']-1)+1; ?>
</td>
                <td><a href="/proofread/stage2-correction?submenuId=ML3-SL2&articleId=<?php echo $this->_tpl_vars['s2arts_item']['artId']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['s2arts_item']['deliveryTitle'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('wordwrap', true, $_tmp, 20, "\n", true) : smarty_modifier_wordwrap($_tmp, 20, "\n", true)); ?>
</a></td>
                <td><?php if ($this->_tpl_vars['s2arts_item']['company_name'] != ''): ?><?php echo $this->_tpl_vars['s2arts_item']['company_name']; ?>
<?php else: ?><?php echo $this->_tpl_vars['s2arts_item']['email']; ?>
<?php endif; ?></td>
                <td><?php echo $this->_tpl_vars['s2arts_item']['artCount']; ?>
</td>
                <td><?php echo $this->_tpl_vars['s2arts_item']['affectedart']; ?>
 </td>
                <td><?php echo $this->_tpl_vars['s2arts_item']['notaffectedart']; ?>
</td>
                <td><?php echo $this->_tpl_vars['s2arts_item']['bidencours']; ?>
</td>
                <td><?php echo $this->_tpl_vars['s2arts_item']['incharge']; ?>
</td>
            </tr>
