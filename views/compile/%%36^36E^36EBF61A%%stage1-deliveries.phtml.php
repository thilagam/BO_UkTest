<?php /* Smarty version 2.6.19, created on 2013-07-18 17:01:26
         compiled from gebo/proofread/stage1-deliveries.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/proofread/stage1-deliveries.phtml', 90, false),array('modifier', 'stripslashes', 'gebo/proofread/stage1-deliveries.phtml', 160, false),array('modifier', 'wordwrap', 'gebo/proofread/stage1-deliveries.phtml', 160, false),)), $this); ?>
<?php echo '
...
<div class="row-fluid">
  <div class="span12">
    <h3 class="heading">Stage 1 Deliveries<a data-toggle="modal"  href="#searchpopup" ></a></h3>

        <table id="s1delgrid" class="table table-bordered table-striped table_vam">
            <thead>
            <tr>
                <th>Sl.no</th>
                <th>Titre AO</th>
...
?>
            <tr>
                <td><?php echo ($this->_foreach['s1del_loop']['iteration']-1)+1; ?>
</td>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['s1del_item']['deliveryTitle'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('wordwrap', true, $_tmp, 20, "\n", true) : smarty_modifier_wordwrap($_tmp, 20, "\n", true)); ?>
</td>
                <td><?php if ($this->_tpl_vars['s1del_item']['company_name'] != ''): ?><?php echo $this->_tpl_vars['s1del_item']['company_name']; ?>
<?php else: ?><?php echo $this->_tpl_vars['s1del_item']['email']; ?>
<?php endif; ?></td>
                <td><?php echo $this->_tpl_vars['s1del_item']['artCount']; ?>
</td>
                <td class="num-large"><a href="/proofread/stage1-articles?submenuId=ML3-SL2&aoId=<?php echo $this->_tpl_vars['s1del_item']['delivery_id']; ?>
" ><?php echo $this->_tpl_vars['s1del_item']['atraiter']; ?>
</a></td>
                <td><?php echo $this->_tpl_vars['s1del_item']['traiter']; ?>
</td>
                <td><?php echo $this->_tpl_vars['s1del_item']['incharge']; ?>
</td>
                <td><?php if ($this->_tpl_vars['s1del_item']['notclosedprofiles'] == 'NO'): ?>NOT CLOSED<?php else: ?>CLOSED<?php endif; ?></td>
            </tr>
