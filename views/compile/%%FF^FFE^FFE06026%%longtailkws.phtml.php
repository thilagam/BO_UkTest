<?php /* Smarty version 2.6.19, created on 2015-03-24 12:02:16
         compiled from gebo/seo/longtailkws.phtml */ ?>
<form class="form_validation_reg" method="POST" action="/seotool/longtailkw_upload" name="importcsv" id="seo" ENCTYPE="multipart/form-data">
    <div class="span10">

        <h3 class="heading">Long tail keyword Tool</h3>
            ...
            <div class="row-fluid">
                <div class="span12 form-inline">
                    ...
                    <label class="uni-radio">
                        <input type="radio" name="word_type" class="uni_style"  value="1" <?php if ($this->_tpl_vars['word_type'] != '2'): ?> checked <?php endif; ?> id="csvxls">
                        File</label>
                    <label class="uni-radio">
                        <input type="radio" name="word_type" class="uni_style"  value="2" <?php if ($this->_tpl_vars['word_type'] == '2'): ?> checked <?php endif; ?> id="opt_text">
                        Text</label>
                </div>
            </div>
        </div>
        ...
        <div class="control-group formSep">
            <div class="row-fluid">
                <div class="span12 form-inline">
                    ...
                    <label class="uni-radio">
                        <input type="radio" name="op_type" class="uni_style"  value="2" checked>
                        xls</label>
                    <label class="uni-radio">
                        <input type="radio" name="op_type" class="uni_style"  value="1">
                        csv</label>
                </div>
            </div>
        </div>
