<?php /* Smarty version 2.6.19, created on 2015-03-11 12:53:06
         compiled from gebo/stats/contribpayablelist.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'gebo/stats/contribpayablelist.phtml', 138, false),array('modifier', 'replace', 'gebo/stats/contribpayablelist.phtml', 510, false),array('modifier', 'date_format', 'gebo/stats/contribpayablelist.phtml', 514, false),array('function', 'html_options', 'gebo/stats/contribpayablelist.phtml', 470, false),)), $this); ?>
<?php echo '
...
"  placeholder="Invoice no" />
                    ...
                    <span class="sepV_c">
                        <select id="paid_type" name="paid_type" data-placeholder="Payment status">
                            <option value=""></option>
                            <option value="All" <?php if ($this->_tpl_vars['paid_type'] == 'All'): ?> selected<?php endif; ?> >All</option>
                            <option value="notpaid" <?php if ($this->_tpl_vars['paid_type'] == 'notpaid'): ?> selected<?php endif; ?>>new application</option>
                            <option value="refuse" <?php if ($this->_tpl_vars['paid_type'] == 'refuse'): ?> selected<?php endif; ?>>Refused</option>
                        </select> </span>
                    <span class="sepV_c">
...
<?php endif; ?></a></td>
                     <td><?php if ($this->_tpl_vars['payablecontrib_item']['updated_at'] != "0000-00-00 00:00:00"): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['payablecontrib_item']['updated_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
<?php else: ?>-<?php endif; ?></td>
					<td><?php echo ((is_array($_tmp=$this->_tpl_vars['payablecontrib_item']['created_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</td>
					<td> <?php if ($this->_tpl_vars['payablecontrib_item']['pay_later_month_name']): ?> 15th of <?php echo $this->_tpl_vars['payablecontrib_item']['pay_later_month_name']; ?>
  <?php else: ?> - <?php endif; ?> </td>
...
', 'pay-contributor-process');"><button class="btn hint--bottom hint--info" data-hint="Paye"><i class="splashy-thumb_up"></i></button></a>
...
');" id="print" class="btn hint--bottom hint--info" data-hint="Print" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['payablecontrib_item']['invoiceId'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'ep_invoice_', '') : smarty_modifier_replace($_tmp, 'ep_invoice_', '')); ?>
 " style="cursor: pointer;" ><i class="splashy-printer"></i> </a></td>
        ...
        <!--<div style="text-align:center;padding-left:600px;">            
            <div style="border-radius:7px;background-color:#eed3d7;width:120px;border-color: #7d7d7d;border: solid 2px;height: 20px;">mmm<?php echo count($this->_tpl_vars['paginator']); ?>
</div>
        </div>-->
