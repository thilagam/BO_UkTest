<?php /* Smarty version 2.6.19, created on 2015-08-06 09:54:18
         compiled from gebo/followup/staff-task.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_encode', 'gebo/followup/staff-task.phtml', 2, false),array('modifier', 'zero_cut_t', 'gebo/followup/staff-task.phtml', 11, false),array('modifier', 'stripslashes', 'gebo/followup/staff-task.phtml', 91, false),array('modifier', 'htmlentities', 'gebo/followup/staff-task.phtml', 91, false),array('modifier', 'nl2br', 'gebo/followup/staff-task.phtml', 91, false),)), $this); ?>
...
;</span>
		...
		<div class="row-fluid topset2">
			<form class="form-horizontal" enctype="multipart/form-data" action="/followup/submit-stafftask" id="taskadd" method="POST">
...
" class="btn btn-small">Download Zip</a>
				...
				<div class="control-group">
					<div class="controls topset2 pull-center" style="margin-left:0">
					<a href="/followup/stafftask?tid=<?php echo $this->_tpl_vars['viewarray']['task_id']; ?>
