<?php /* Smarty version 2.6.19, created on 2015-07-14 14:36:43
         compiled from gebo/processao/liberte-refuseaos.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'gebo/processao/liberte-refuseaos.phtml', 69, false),array('modifier', 'wordwrap', 'gebo/processao/liberte-refuseaos.phtml', 69, false),array('modifier', 'upper', 'gebo/processao/liberte-refuseaos.phtml', 69, false),array('modifier', 'date_format', 'gebo/processao/liberte-refuseaos.phtml', 70, false),array('modifier', 'string_format', 'gebo/processao/liberte-refuseaos.phtml', 84, false),)), $this); ?>
<?php echo '
...
<?php endif; ?></a></td>
                      <td><?php echo ((is_array($_tmp=$this->_tpl_vars['refusedaos_item']['created_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</td>
