<?php /* Smarty version 2.6.19, created on 2015-03-24 12:04:22
         compiled from gebo/seo/kw_generator.phtml */ ?>
<?php echo '
...
<form class="form_validation_reg" method="POST" action="/seotool/keyword-generation-process" name="importcsv" id="seo" ENCTYPE="multipart/form-data">
        <div class="span10">

            <h3 class="heading">kEYWORD GENERATION TOOL</h3>
