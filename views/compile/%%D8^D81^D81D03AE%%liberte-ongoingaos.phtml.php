<?php /* Smarty version 2.6.19, created on 2015-07-14 14:30:58
         compiled from gebo/processao/liberte-ongoingaos.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'gebo/processao/liberte-ongoingaos.phtml', 68, false),array('modifier', 'wordwrap', 'gebo/processao/liberte-ongoingaos.phtml', 68, false),array('modifier', 'upper', 'gebo/processao/liberte-ongoingaos.phtml', 68, false),array('modifier', 'date_format', 'gebo/processao/liberte-ongoingaos.phtml', 69, false),array('modifier', 'string_format', 'gebo/processao/liberte-ongoingaos.phtml', 83, false),)), $this); ?>
<?php echo '
...
-->     <div class="hide" id="searchblock">
     ...
     <div class="tabbable">
         ...
         <div id="ongoingtab" class="tab-pane">
              <table id="ongoingmissionsgrid" class="table table-bordered table-striped table_vam" >
                  <thead>
                   <tr>
                    <th>SL.NO</th>
                    <th>Title</th>
...
<?php endif; ?></a></td>
                      <td><?php echo ((is_array($_tmp=$this->_tpl_vars['ongoingaos_item']['created_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</td>
