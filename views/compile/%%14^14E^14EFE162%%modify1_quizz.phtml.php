<?php /* Smarty version 2.6.19, created on 2016-03-21 11:33:35
         compiled from gebo/quizz/modify1_quizz.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/quizz/modify1_quizz.phtml', 33, false),)), $this); ?>
<?php echo '
...
<form action="/quizz/modify1quizz?submenuId=ML2-SL22<?php echo '&id='.$_REQUEST['id']; ?>" name="bo_quizzstep1_form" method="post" enctype="multipart/form-data"  onSubmit="return validate_bo_quizzstep1();" >
<div class="row-fluid">
	<div class="span12">
...
" class="span2" <?php if ($this->_tpl_vars['participants'] > 0): ?>readonly<?php endif; ?> /></td>
			</tr>   
			<tr>
