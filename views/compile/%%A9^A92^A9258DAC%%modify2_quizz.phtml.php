<?php /* Smarty version 2.6.19, created on 2015-12-18 11:48:14
         compiled from gebo/quizz/modify2_quizz.phtml */ ?>
<?php echo '
...
<?php echo '
    ...
    {
        window.location=\'/quizz/modifyquizz?submenuId=ML2-SL22&mod=1'; ?>
...
<form action="/quizz/modify2quizz?submenuId=ML2-SL22<?php echo '&id='.$_REQUEST['id']; ?>" name="bo_quizzstep2_form" method="post" enctype="multipart/form-data"  onSubmit="return validate_bo_quizzstep2();" >
  <div class="row-fluid">
	<div class="span12">
...
" class="span9 qn" value="<?php echo $this->_tpl_vars['quizz'][$this->_tpl_vars['qns']]; ?>
...
" value="1" class="uni_style" <?php if ($this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] == $this->_tpl_vars['quizz'][$this->_tpl_vars['ansid1']] && $this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] != ''): ?> checked<?php endif; ?>/>
						</label>
...
"/>
						...
						<label class="uni-radio">
							<input type="radio" name="r_an<?php echo $this->_tpl_vars['i']; ?>
" value="2"  class="uni_style" <?php if ($this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] == $this->_tpl_vars['quizz'][$this->_tpl_vars['ansid2']] && $this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] != ''): ?> checked<?php endif; ?>/>
						</label>	
					</span><br />
					<span class="quizzAns">
...
"/>
						...
						<label class="uni-radio">
							<input type="radio" name="r_an<?php echo $this->_tpl_vars['i']; ?>
" value="3" class="uni_style" <?php if ($this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] == $this->_tpl_vars['quizz'][$this->_tpl_vars['ansid3']] && $this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] != ''): ?> checked<?php endif; ?>/>
						</label>
					</span><br />
					<span class="quizzAns">
...
" />
						...
						<label class="uni-radio">
							<input type="radio" name="r_an<?php echo $this->_tpl_vars['i']; ?>
" value="4" class="uni_style" <?php if ($this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] == $this->_tpl_vars['quizz'][$this->_tpl_vars['ansid4']] && $this->_tpl_vars['quizz'][$this->_tpl_vars['rans']] != ''): ?> checked<?php endif; ?>/>
						</label>
					</span>
...
');" style="float:right;"><img src="/BO/theme/gebo/img/reject-icon.png" /></a>
					<?php endif; ?>
				</td>
			</tr>
