<?php /* Smarty version 2.6.19, created on 2015-06-26 14:57:35
         compiled from gebo/deliveryongoing/ao-contribmail.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_encode', 'gebo/deliveryongoing/ao-contribmail.phtml', 102, false),)), $this); ?>
<?php echo '
		...
		<form class="form-horizontal form_validation_ttip form_validation_reg"  action="" method="POST" id="contribmail_form">
			<fieldset>
				...
				<div class="control-group">
						...
						<div class="controls">
							<div class="pull-left">
							<select name='cemail_from' class='cselect' style='width:140px'>
								<option value='support@edit-place.com'>Editorial team</option>
				...
				<div class="control-group formSep">
					<label class="control-label">Type de contributeur</label>
					<div class="controls form-inline">
						<label class="uni-radio">
							<input type="checkbox" value="writer"  name="contrib_type[]" class="uni_style validate[minCheckbox[1]]" checked onClick="loadcontribs()" />R&eacute;dacteur
						</label>
						<label class="uni-radio">
							<input type="checkbox" value="corrector" name="contrib_type[]" class="uni_style validate[minCheckbox[1]]" checked onClick="loadcontribs()" />Correcteur
						</label>						
					</div>
				</div>
				<div class="control-group formSep">
					<label for="fileinput" class="control-label">Contributeurs</label>
...
" selected><?php echo $this->_tpl_vars['contrib']['email']; ?>
 ...
 , <?php echo ((is_array($_tmp=$this->_tpl_vars['contrib']['last_name'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : smarty_modifier_utf8_encode($_tmp)); ?>
				...
				<div class="control-group formSep">
					<label for="fileinput" class="control-label">Object de l'email</label>
					<div class="controls">
						<input type="text" name="email_subject" id="email_subject" placeholder="Subject..." class="span10 validate[required]"/>					
					</div>
				</div>
				<div class="control-group formSep">
					<label for="fileinput" class="control-label">Contentu de l'email</label>
					<div class="controls">
...
"/>
						<button class="btn btn-gebo" type="submit" name="sendcontrib_mail" id="sendcontrib_mail" value="send">Envoyer</button>
