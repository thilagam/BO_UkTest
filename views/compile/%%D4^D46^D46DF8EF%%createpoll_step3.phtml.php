<?php /* Smarty version 2.6.19, created on 2016-03-18 07:58:00
         compiled from gebo/ao/createpoll_step3.phtml */ ?>
<?php echo '
  	...
  	<div class="span12">
		<h3 class="heading">
			...
			<table align="center" cellpadding="4" cellspacing="4" width="78%">
				<tr>
					<td>Include blacklisted writers</td>
					<td>
						<div id="black_contribcheck">
							<input type="checkbox" name="black_contrib" id="black_contrib" onChange="countmails('<?php echo $this->_tpl_vars['category']; ?>
');" <?php if ($this->_tpl_vars['black_contrib'] == 'on'): ?>checked="checked"<?php endif; ?>/>
						</div>
					</td>
				</tr>
				<tr>
					<td>editors concerned</td>
					<td>
						<select name="contrib" id="contrib" onChange="countmails('<?php echo $this->_tpl_vars['category']; ?>
');">
				...
				<tr>
					...
					<td>
						<div id="send_mailcheck">
							<input type="checkbox" name="send_mail" id="send_mail" <?php if ($this->_tpl_vars['send_mail'] == 'on'): ?>checked="checked"<?php endif; ?>/>
						</div>
...
<input type="hidden" name="cat" id="cat" value="<?php echo $this->_tpl_vars['category']; ?>
" />
</form>
	</div>
</div>
