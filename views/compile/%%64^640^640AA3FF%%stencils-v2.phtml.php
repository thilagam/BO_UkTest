<?php /* Smarty version 2.6.19, created on 2016-01-19 07:12:10
         compiled from gebo/followup/stencils-v2.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gebo/followup/stencils-v2.phtml', 27, false),array('modifier', 'htmlentities', 'gebo/followup/stencils-v2.phtml', 36, false),array('modifier', 'cat', 'gebo/followup/stencils-v2.phtml', 95, false),array('modifier', 'explode', 'gebo/followup/stencils-v2.phtml', 101, false),array('modifier', 'in_array', 'gebo/followup/stencils-v2.phtml', 106, false),)), $this); ?>
<?php echo '
<style>
#searchform
{
				...
				<div class="row-fluid">
					...
					<span class="span3">
                        <select name="category" onchange="loadcategory()"   class="span12 catselect themes validate[required]" id="category" data-placeholder="Category">
							                            <option value=""></option>
                            <?php $_from = $this->_tpl_vars['sthemes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['stheme']):
?>
                                <?php if ($this->_tpl_vars['stheme'] == 'Weather' || $this->_tpl_vars['stheme'] == 'weather'): ?>
                                    <option value="<?php echo $this->_tpl_vars['id']; ?>
" label="<?php echo $this->_tpl_vars['stheme']; ?>
" <?php if ($this->_tpl_vars['id'] == $this->_tpl_vars['stheme_selected']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['stheme'])) ? $this->_run_mod_handler('htmlentities', true, $_tmp) : smarty_modifier_htmlentities($_tmp)); ?>
</option>
                                <?php endif; ?>
...
"
                    ...
                    <td class="hidden_replaced">
                        <?php echo $this->_tpl_vars['stencil']['final_stencil']; ?>
                ...
                <?php $this->assign('theme_name', $this->_tpl_vars['stencil']['token']['theme_name']); ?>            <?php endforeach; endif; unset($_from); ?>
		</tbody>
	</table>
	...
	<div class="span12 pull-center">
		...
		<button class="btn btn-primary topset2" type="button" onclick="generateFinalStencil('<?php echo $this->_tpl_vars['theme_name']; ?>
','false')">Generate Stencil Code</button>
	</div>
