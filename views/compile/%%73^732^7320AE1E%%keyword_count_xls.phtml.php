<?php /* Smarty version 2.6.19, created on 2015-03-24 12:21:05
         compiled from gebo/seo/keyword_count_xls.phtml */ ?>
...
<?php if ($this->_tpl_vars['msg'] != ''): ?>
        <div class="alert alert-<?php echo $this->_tpl_vars['class']; ?>
" id="seo-message" style="disply:block;width:800px;">
            <div class="row-fluid">
                <div class="span12 form-inline"><?php echo $this->_tpl_vars['msg']; ?>
</div>
            </div>
        </div>
<?php endif; ?>
