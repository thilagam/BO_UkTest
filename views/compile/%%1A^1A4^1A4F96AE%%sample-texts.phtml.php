<?php /* Smarty version 2.6.19, created on 2016-03-02 11:43:23
         compiled from gebo/bnp/sample-texts.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'gebo/bnp/sample-texts.phtml', 1, false),array('modifier', 'utf8_encode', 'gebo/bnp/sample-texts.phtml', 15, false),array('modifier', 'htmlentities', 'gebo/bnp/sample-texts.phtml', 15, false),)), $this); ?>
<?php if (count($this->_tpl_vars['sampletexts']) > 0): ?>
<form class="form-horizontal"  action="" method="get" id="sampletxt_form2">
    <table class="table" id="sampletext_table">
        <thead>
        <tr>
            <th colspan="2" style="text-align:left"><h2> Sample texts for <?php echo $this->_tpl_vars['city_name']; ?>
 </h2></th>
        </tr>
        </thead>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['sample']['title'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : smarty_modifier_utf8_encode($_tmp)))) ? $this->_run_mod_handler('htmlentities', true, $_tmp) : smarty_modifier_htmlentities($_tmp)); ?>
</label>
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    $("#sampletxt_form2").validationEngine({prettySelect : true,useSuffix: "_chzn",onValidationComplete: function(form, status){
        if(status===true)
        {
