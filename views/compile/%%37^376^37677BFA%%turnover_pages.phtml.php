<?php /* Smarty version 2.6.19, created on 2016-01-14 08:38:52
         compiled from skeleton/turnover_pages.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'skeleton/turnover_pages.phtml', 10, false),array('modifier', 'stripslashes', 'skeleton/turnover_pages.phtml', 10, false),array('modifier', 'substr', 'skeleton/turnover_pages.phtml', 21, false),)), $this); ?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<script>
	...
	$(".modal-body textarea").on(\'click\',function(){
			var current = $(this);
			setTimeout(function(){current.focus()}, 150);
			});
	});
</script>
'; ?>
