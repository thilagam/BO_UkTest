<?php /* Smarty version 2.6.19, created on 2014-12-11 14:14:57
         compiled from gebo/processao/article-profiles.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'gebo/processao/article-profiles.phtml', 489, false),array('modifier', 'stripslashes', 'gebo/processao/article-profiles.phtml', 530, false),array('modifier', 'wordwrap', 'gebo/processao/article-profiles.phtml', 530, false),array('modifier', 'explode', 'gebo/processao/article-profiles.phtml', 578, false),)), $this); ?>
<?php echo '
...
<?php echo ';
    ...
    $("#selectAlsl").click(function(){
        var checked_status = this.checked;
        $("input[name=\'artchk[]\']").each(function(){
    ...
    if(closemode == \'close\')
    {
        ...
        else
        {
            smoke.confirm("Do you really want to close this aritcle",function(e){
                ...
                {
                    $.ajax({
                        url: "/processao/closeartprofile?artid="+artid+"&closemode="+closemode,
                        global: false,
                        type: "GET",
                        dataType: "html",
                        async:false,
...
function closeArtprofile(artid, participants)
{
    ...
    if(participants == \'no\')
    {
        smoke.confirm("Do you want ot close this article? No contributor has participated, no emails will be sent",function(e){
            if (e)
            {
                $.ajax({
                    url: "/republish/closeartprofile?art_id="+artid+"&participants="+participants,
                    global: false,
                    type: "GET",
                    dataType: "html",
                    async:false,
...
<?php echo ';
    ...
    $.post(target_page, function(data){ // alert(data);
        ...
        {
            smoke.confirm("Are you sure want to make that choice instead of"+obj[1],function(e){
                if (e)
                {
...
function postBulkRepublish()
{
    ...
    else
    {
        ...
        $("#next").html($(\'<button type="button" data-toggle="modal" data-target="#republish" href="/republish/bulkrepublishpopup?nopart=no&close=no&aoId=\'+aoId+\'&artlist=\'+artarray+\'" id="bulkrepublish" name="bulkrepublish" class="btn btn-info">Re publier</button>\'));
    }
...
<h3 class="heading">Article profiles<a class="label label-inverse pull-right" href="/processao/profiles-list?submenuId=ML2-SL2" id="returnback">return</a></h3>
<div class="row-fluid">
<div class="span12">
...
<table id="artprofilesgrid1" class="table table-bordered table-striped table_vam">
    ...
    <tr>
        ...
        <!--<th><input type="checkbox" id="selectAll" name="selectAll" value="selectall" class="uni_style" onclick="CheckALL();" /></th>-->
        <th>Sl.no</th>
...
"/>
    <tr>
        <td><?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] != 'stage0' && $this->_tpl_vars['artprofiles_item']['current_stage'] != 'stage1' && $this->_tpl_vars['artprofiles_item']['current_stage'] != 'stage2' && $this->_tpl_vars['artprofiles_item']['status'] != 'published' && time() > $this->_tpl_vars['artprofiles_item']['participation_expires']): ?>
...
" class="uni_style" <?php if ($this->_tpl_vars['artprofiles_item']['selection_type'] == 'bo' || $this->_tpl_vars['artprofiles_item']['selection_type'] == 'auto'): ?> disabled=disabled <?php endif; ?>/>
    ...
    <tr><td><b>Prix demand</b></td><td><?php echo $this->_tpl_vars['artprofiles_item']['price_min']; ?>
-<?php echo $this->_tpl_vars['artprofiles_item']['price_max']; ?>
 &euro;</td></tr>
    <tr><td><b>Cr&Eacute;e le</b></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['artprofiles_item']['created_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%d/%m/%Y') : smarty_modifier_date_format($_tmp, '%d/%m/%Y')); ?>
</td></tr>
    <tr><td><b>Statut</b></td><td><?php if ($this->_tpl_vars['artprofiles_item']['status'] == 'bid_premium'): ?> New
...
<td><?php if ($this->_tpl_vars['artprofiles_item']['lock_status'] == 'yes' && $this->_tpl_vars['artprofiles_item']['lockedUser'] == $this->_tpl_vars['userId']): ?>
    <a data-target="#groupprofile"  class="artprofiles <?php if ($this->_tpl_vars['artprofiles_item']['cycle0UserCount'] != 1): ?> num-large <?php endif; ?>" id="grpprofilelink<?php echo ($this->_foreach['artprofiles_loop']['iteration']-1); ?>
"  data-toggle="modal" data-refresh="true" role="button"  href="/processao/group-profiles?artId=<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
" >
...
<td>
    <?php if ($this->_tpl_vars['artprofiles_item']['bo_closed_status'] == 'closed'): ?>
    <span class="label label-info">Article closed</span>
    <?php elseif ($this->_tpl_vars['artprofiles_item']['pstatus'] == ""): ?>
    <span class="label label-info">no participation</span>
    <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires'] && $this->_tpl_vars['artprofiles_item']['participation_expires'] != '0'): ?>
                       <span id="time_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
_<?php echo $this->_tpl_vars['artprofiles_item']['participation_expires']; ?>
...
"></span>
    ...
    <?php if (in_array ( 'bid_premium|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_premium|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_premium|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <?php if (time() > $this->_tpl_vars['artprofiles_item']['participation_expires'] && $this->_tpl_vars['artprofiles_item']['participation_expires'] != '0'): ?>
    <span class="label label-success">To validate</span>
    <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?>
                            <span id="time_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
_<?php echo $this->_tpl_vars['artprofiles_item']['participation_expires']; ?>
" class="alert alert-danger">
                            <i class="icon-time"></i> <span id="text_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
"></span>
    ...
    <?php endif; ?>
    <?php elseif ($this->_tpl_vars['artprofiles_item']['participation_expires'] == '0'): ?>
    <span class="label label-success">To validate</span>
    <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?>
                            <span id="time_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
"></span>
    ...
    <?php elseif (in_array ( 'bid_temp|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_temp|junior' , $this->_tpl_vars['arrstatus'] )): ?><span class="label label-success">JC validate</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>
    <?php elseif (in_array ( 'bid_temp|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?><span class="label label-success">JC0 validate</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>
    <?php elseif (in_array ( 'bid_nonpremium|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_nonpremium|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_nonpremium|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?><span class="label label-success"> Client valid&eacute;</span><!-- BY CLIENT-->
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>
    <?php elseif (in_array ( 'bid|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'under_study|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'disapproved|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'plag_exec|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'on_hold|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'time_out|senior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">SC validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>

    <?php elseif (in_array ( 'published|senior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">SC validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Published</span><?php endif; ?>

    <?php elseif (in_array ( 'published|junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">JC validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Published</span><?php endif; ?>

    <?php elseif (in_array ( 'published|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">JC0 validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Published</span><?php endif; ?>

    <?php elseif (in_array ( 'bid|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'under_study|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'plag_exec|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'disapproved|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'on_hold|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'time_out|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'published|junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">JC validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>

    <?php elseif (in_array ( 'bid|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'under_study|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'plag_exec|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'disapproved|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'on_hold|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'time_out|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'published|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <span class="label label-success">JC0 validated</span>
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'contributor'): ?>
    <span class="label label-warning">Editor</span><?php endif; ?>
    <?php elseif (in_array ( 'bid_refused|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_refused|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'closed|senior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'closed|junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'bid_refused|sub-junior' , $this->_tpl_vars['arrstatus'] ) || in_array ( 'closed|sub-junior' , $this->_tpl_vars['arrstatus'] )): ?>
    <?php if (time() > $this->_tpl_vars['artprofiles_item']['participation_expires'] && $this->_tpl_vars['artprofiles_item']['participation_expires'] != '0'): ?>
    <span class="label label-success">Ongoing</span>
    <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?>
                            <span id="time_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
"></span>
    ...
    <?php endif; ?>
    <?php else: ?>
    <span class="label label-important">ongoings</span>
    <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?>
                            <span id="time_<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
_<?php echo $this->_tpl_vars['artprofiles_item']['participation_expires']; ?>
" class="alert alert-danger">
...
">
                ...
                <?php if ($this->_tpl_vars['artprofiles_item']['bo_closed_status'] == ''): ?>

                     <?php if ($this->_tpl_vars['artprofiles_item']['status'] != ''): ?>
                        <?php if ($this->_tpl_vars['artprofiles_item']['status'] == 'bid_premium' || $this->_tpl_vars['artprofiles_item']['status'] == 'bid_temp' || $this->_tpl_vars['artprofiles_item']['status'] == 'bid_refused_temp'): ?>
                            <button type="button" id="closebutton<?php echo ($this->_foreach['artprofiles_loop']['iteration']-1); ?>
" <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?> disabled="disabled" <?php endif; ?> onclick="closeArtprofile('firstvalidate', 'close');" class="btn btn-info">close</button>
                        <?php else: ?>
                            <button type="button" id="closebutton<?php echo ($this->_foreach['artprofiles_loop']['iteration']-1); ?>
" <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?> disabled="disabled" <?php endif; ?> onclick="return closeArtprofile('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
', 'close');" class="btn btn-info">close</button>
                ...
                <?php else: ?>
                 <button type="button" id="closebutton<?php echo ($this->_foreach['artprofiles_loop']['iteration']-1); ?>
" <?php if (time() < $this->_tpl_vars['artprofiles_item']['participation_expires']): ?> disabled="disabled" <?php endif; ?> onclick="return closeArtprofile('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
', 'disclose');" class="btn btn-info">Closed</button>
                <?php endif; ?>
                </span>-->
    <?php if ($this->_tpl_vars['artprofiles_item']['current_stage'] == 'stage0' || $this->_tpl_vars['artprofiles_item']['current_stage'] == 'stage1' || $this->_tpl_vars['artprofiles_item']['current_stage'] == 'stage2' || $this->_tpl_vars['artprofiles_item']['status'] == 'published' || time() < $this->_tpl_vars['artprofiles_item']['participation_expires'] || $this->_tpl_vars['artprofiles_item']['missiontest'] == 'yes'): ?>
    &nbsp;
    <?php else: ?>
        <button type="button" data-toggle="modal" data-target="#republish" href="/republish/republishpopup?artId=<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
"><button type="button" class="btn btn-success">select</button></a>
    <?php if ($this->_tpl_vars['artprofiles_item']['bo_closed_status'] == ''): ?>
    <?php if ($this->_tpl_vars['artprofiles_item']['status'] != 'bid' || $this->_tpl_vars['artprofiles_item']['status'] != 'under_study'): ?>
        <?php if ($this->_tpl_vars['artprofiles_item']['cycle0UserCount'] == 0): ?>
        <a data-toggle="modal" data-target="#close" href="#" onclick="closeArtprofile('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
', 'no');"><button type="button" class="btn btn-inverse">Close</button></a>
        <?php else: ?>
        <a data-toggle="modal" data-target="#close" href="#" onclick="return getCloseComment('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
', '<?php echo $this->_tpl_vars['artprofiles_item']['cycle0UserCount']; ?>
')"><button type="button" class="btn btn-inverse">Close</button></a>
        <?php endif; ?>
    <?php endif; ?>
    <?php endif; ?>
</td>
...
');"><i class="splashy-lock_large_unlocked"></i></a>
             <?php else: ?>
                <div>Locked by <?php echo $this->_tpl_vars['artprofiles_item']['lockedby_name'][0]['login']; ?>
</div>
                        <?php endif; ?>
                    <?php else: ?>
                           <a onclick="articlProfilelockSystem('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
...
<div>
    <input type="hidden" id="delId" name="delId" value="<?php echo $this->_tpl_vars['aoId']; ?>
" />
    <button type="button" onclick="postBulkRepublish();" id="bulkrepublish1" name="bulkrepublish1" class="btn btn-info">Re publish</button>
    <div id="next">   </div>
    <div>
</form>
</div>
...
<div class="modal hide fade" id="closemail">
    <div class="modal-header">
        <button class="close" onclick="closePopup('closemail');">&times;</button>
        <h3>CLOSE ARTICLE</h3>
    </div>
    <div class="modal-body">
        <h3 id="bodymsg"></h3>
    ...
    <div class="modal-footer">
        <input type="hidden" id="artid" name="artid" />
        <button type="button" id="closeart"  name="closeart" class="btn btn-danger" onclick="closeArtprofile('<?php echo $this->_tpl_vars['artprofiles_item']['artId']; ?>
', 'yes');" >Valide</button>
    </div>
</div>
...
<!--///when republish the popup comes for edit details and mail for republish article///-->
<div class="modal4 hide fade" id="bulkrepublish">
    <div class="modal-header">
        <button class="close" data-dismiss="modal" >&times;</button>
        <h3>Bulk Re-publish the article</h3>
    </div>
    <div class="modal-body">
    </div>
    <div class="modal-footer">
