...
class Ep_User_Client extends Ep_Db_Identifier
{
	...
	{	
		 $SelectallContrib="SELECT u.first_name,u.last_name,us.email,u.phone_number,c.company_name,us.identifier FROM UserPlus u
		                    INNER JOIN User us ON u.user_id=us.identifier LEFT JOIN Client c ON u.user_id=c.user_id where u.user_id='".$uid."'";
