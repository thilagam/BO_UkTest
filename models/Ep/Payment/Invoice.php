...
class Ep_Payment_Invoice extends Ep_Db_Identifier
{
	...
	{
	      $query = "select i.invoiceId, i.user_id, i.created_at, i.total_invoice_paid, i.payment_type, CONCAT(up.first_name,' ',up.last_name) as first_name,i.status,i.refuse_count,i.updated_at,i.currency,i.ep_admin_fee,i.ep_admin_fee_percentage,i.pay_later_month,i.pay_later_percentage from ".$this->_name." i
